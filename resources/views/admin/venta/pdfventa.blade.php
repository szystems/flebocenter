        ...
        <table class="table" Width=100%>
            <thead>
                <tr>
                    ...
                    <th align="center">
                        <font size="1">Compra/Utilidad</font>
                    </th>
                    <th align="right">
            ...
            <tbody>
                ...
                @foreach ($ventaDetalles as $detalle)
                    <tr>
                        ...
                        @endphp
                        <td align="center">
                            <b><font color="orange">{{ $config->currency_simbol }}.{{ number_format($compra,2, '.', ',') }}</font> / <font color="limegreen"><strong>{{ $config->currency_simbol }}.{{ number_format($utilidad,2, '.', ',') }}</strong></font></b>
                        </td>
                        <td align="right">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <h4><b><font color="gray">Compra/Utilidad: </font><font color="orange">{{ $config->currency_simbol }}.{{ number_format($total_compra,2, '.', ',') }}</font> / <font color="limegreen">{{ $config->currency_simbol }}.{{ number_format($total_utilidad,2, '.', ',') }}</font></b></h4>
                    </td>
                    <td colspan="2" align="right">
