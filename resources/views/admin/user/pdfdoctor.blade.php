        ...
        <table class="table">
            <thead>
                ...
                <tr>
                    ...
                    <td colspan="3">{{ $doctor->telefono }} / {{ $doctor->celular }}</td>
                </tr>
                <tr>
                    <th align="right">Dirección</th>
                    <td colspan="5">{{ $doctor->direccion }}</td>
                </tr>
                <tr>
                    <th align="right">Descripción</th>
                    <td colspan="5">{{ $doctor->descripcion }}</td>
                </tr>
                @if ($doctor->fotografia != null)
                <tr>
                    <th align="right">Imagen:</th>
                    <td align="center" colspan="5">
                        <img src="{{$pathdoctor.$doctor->fotografia}}" style="max-height: 200px; width: auto;"/>
                    </td>
                </tr>
                @endif
