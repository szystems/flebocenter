                                    ...
                                    <ul class="nav nav-tabs" id="customTab2" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="tab-oneA" data-bs-toggle="tab" href="#oneA" role="tab"
                                                aria-controls="oneA" aria-selected="true">Crear Doctor</a>
                                        </li>
                                                        ...
                                                        <div class="row gx-3">
                                                            ...
                                                            <div class="col-md-3 mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input name="colegiado" type="text" class="form-control" placeholder="XXXXXX" value="{{ old('colegiado') }}"/>
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea name="descripcion" class="form-control" rows="3" placeholder="Descripción del Doctor...">{{ old('descripcion') }}</textarea>
