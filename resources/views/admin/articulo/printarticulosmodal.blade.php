...
<!-- Modal -->
<div class="modal fade" id="printArticulosModal" tabindex="-1" aria-labelledby="printArticulosModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="printArticulosModalTitle">
                    <i class="bi bi-printer text-info"></i> Imprimir
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ url('print-articulos') }}" method="GET" target="_blank">
