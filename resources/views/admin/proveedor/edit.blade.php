                                                    ...
                                                    <div class="row gx-3">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="nombre" type="text" class="form-control" placeholder="Nombre de la proveedor..." value="{{ $proveedor->nombre }}" />
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="contacto" type="text" class="form-control" placeholder="Contacto del proveedor..." value="{{ $proveedor->contacto }}" />
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="telefono" type="number" oninput="this.value = this.value.replace(/[^0-9]/g, '');" class="form-control" placeholder="Telefono del proveedor..." value="{{ $proveedor->telefono }}" />
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="email" type="text" class="form-control" placeholder="Email del proveedor..." value="{{ $proveedor->email }}" />
                                                                @if ($errors->has('email'))
                                                                    <span class="help-block opacity-7">
                                                                            <strong>
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="banco" type="text" class="form-control" placeholder="Banco del proveedor..." value="{{ $proveedor->banco }}" />
                                                                @if ($errors->has('banco'))
                                                                    <span class="help-block opacity-7">
                                                                            <strong>
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="nombre_cuenta" type="text" class="form-control" placeholder="Nombre de cuenta del proveedor..." value="{{ $proveedor->nombre_cuenta }}" />
                                                        ...
                                                        <div class="col-md-3 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="numero_cuenta" type="text" class="form-control" placeholder="Número de cuenta del proveedor..." value="{{ $proveedor->numero_cuenta }}" />
