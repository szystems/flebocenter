...
@section('content')
    ...
    <div class="content-wrapper-scroll">
        ...
        <div class="content-wrapper">
            ...
            @include('admin.asistente.search')
                                            ...
                                            <td>
                                                <div class="btn-group dropend">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-lg-start">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ url('show-asistente/'.$user->id) }}"><i class="bi bi-eye-fill text-blue"></i> Información</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="{{ url('edit-asistente/'.$user->id) }}"><i class="bi bi-pencil-fill text-warning"></i> Editar</a>
                                                        </li>
                                                        <li>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    @if ($user->fotografia != null)
                                                        <img src="{{ asset('assets/imgs/users/'.$user->fotografia) }}" class="img-4x rounded-5 me-3" alt="Asistentes" />
                                                    @else
                                                        <img src="{{ asset('assets/imgs/users/doctoricon.png') }}" class="img-4x rounded-5 me-3" alt="Asistentes" />
                                                    @endif
