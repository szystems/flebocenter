...
<div class="row gx-3">
    <div class="col-xl-12">
        <div class="card card-background-mask-info">
            ...
            <div class="card-body">
                <form action="{{ url('asistentes') }}" method="GET">
                    @csrf
                    <div class="input-group">
                        <input class="form-control" list="exampleDataList" id="exampleDataList" placeholder="Buscar Asistente ..." name="fuser" value="{{ $queryUser }}"/>
