                                        ...
                                        <div class="tab-pane fade show active" id="oneA" role="tabpanel">
                                            ...
                                            <div class="row gx-3">
                                                ...
                                                <div class="col-sm-12 col-12">
                                                    ...
                                                    @endif
                                                    <form action="{{ url('update-asistente/'.$user->id) }}" method="POST" enctype="multipart/form-data" onsubmit="bloquearBoton()">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="row gx-3">
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea name="direccion" class="form-control" rows="3" placeholder="Direccion del Asistente...">{{ $user->direccion }}</textarea>
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea name="descripcion" class="form-control" rows="3" placeholder="Descripción del Asistente...">{{ $user->descripcion }}</textarea>
