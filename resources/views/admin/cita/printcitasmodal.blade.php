...
<!-- Modal -->
<div class="modal fade" id="printCitasModal" tabindex="-1" aria-labelledby="printCitasModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="printCitasModalTitle">
                    <i class="bi bi-printer text-info"></i> Imprimir
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ url('print-citas') }}" method="GET" target="_blank">
                <div class="modal-body">
                    ...
                    <div class="row gx-3 p-3">
                        ...
                        <input type="hidden" name="fecha_imprimir" value="{{ $fechaVista }}">
                        <input type="hidden" name="estado_imprimir" value="{{ request('festado') }}">
                        <input type="hidden" name="clinica_imprimir" value="{{ request('fclinica') }}">
                        <input type="hidden" name="doctor_imprimir" value="{{ request('fdoctor') }}">
                        <input type="hidden" name="paciente_imprimir" value="{{ request('fpaciente') }}">
