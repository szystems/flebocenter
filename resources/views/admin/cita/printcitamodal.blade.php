...
<!-- Modal -->
<div class="modal fade" id="printCitaModal{{ $cita->id }}" tabindex="-1" aria-labelledby="printCitaModal{{ $cita->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="printCitaModal{{ $cita->id }}Title">
                    <i class="bi bi-printer text-info"></i> Imprimir
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ url('print-cita') }}" method="GET" target="_blank">
