...
@section('content')
                                ...
                                <ul class="nav nav-tabs" id="customTab2" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="tab-oneA" data-bs-toggle="tab" href="#oneA" role="tab"
                                            aria-controls="oneA" aria-selected="true">Crear Cita</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="oneA" role="tabpanel">
                                        ...
                                        <div class="row gx-3">
                                            <div class="col-sm-12 col-12">
                                                ...
                                                @endif
                                                <form action="{{ url('insert-cita') }}" method="POST">
                                                    @csrf
                                                    <div class="row gx-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="clinica_id" class="form-select" aria-label="Default select example">
                                                                    ...
                                                                    @foreach($filtroClinicas as $clinica)
                                                                        <option value="{{ $clinica->id }}"{{ old('clinica_id') == $clinica->id ? ' selected' : '' }}>{{ $clinica->nombre }}</option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <div class="row gx-3">
                                                        ...
                                                        <div class="col-md-2 mb-3">
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <input type="time" name="hora_inicio" class="form-control text-center" placeholder="HH-MM" id="time-formatting2" value="{{ old('hora_inicio') }}"/>
                                                        ...
                                                        <div class="col-md-2 mb-3">
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <input type="time" name="hora_fin" class="form-control text-center" placeholder="HH-MM" id="time-formatting2" value="{{ old('hora_fin') }}"/>
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="motivo" class="form-control" rows="3" placeholder="Motivo de la cita...">{{ old('motivo') }}</textarea>
    ...
    <script>
        ...
        $( '#fecha_cita').datepicker( 'setDate', today );
    </script>
