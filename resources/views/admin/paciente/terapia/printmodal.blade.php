...
<!-- Modal -->
<div class="modal fade" id="printTerapiaModal{{ $terapia->id }}" tabindex="-1" aria-labelledby="printTerapiaModal{{ $terapia->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="printTerapiaModal{{ $terapia->id }}Title">
                    <i class="bi bi-printer text-info"></i> Imprimir
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ url('print-terapia') }}" method="GET" target="_blank">
