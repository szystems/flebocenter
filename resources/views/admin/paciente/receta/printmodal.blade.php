...
<!-- Modal -->
<div class="modal fade" id="printModal{{ $receta->id }}" tabindex="-1" aria-labelledby="printModal{{ $receta->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="printModal{{ $receta->id }}Title">
                    <i class="bi bi-printer text-info"></i> Imprimir
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ url('print-receta') }}" method="GET" target="_blank">
