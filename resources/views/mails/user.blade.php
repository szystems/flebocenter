                                                                                                                    ...
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            <span style="font-size: 16px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">
                                                                                                                                <strong>
                                                                                                                                    Se ha creado un usuario para ti en <a href="{{ url('/') }}">www.asonataxela.com</a>
                                                                                                                                </strong>
                                                                                                                            </span>
                                                                                                                            <ul>
                                                                                                                                <li><b>Nombre:</b> {{ $user->name }}</li>
                                                                                                                                <li><b>Tipo:</b> {{ $user->role_as == '0' ? __('User') : ($user->role_as == '1' ? __('Admin') : ($user->role_as == '3' ? __('Instructor') : "")) }}</li>
                                                                                                                                <li><b>Email:</b> {{ $user->email }}</li>
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">Para acceder a la aplicación con su usuario resetee su contraseña presionando en el siguiente botón:</span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
