                            ...
                            <tr>
                                <td name="bmeMainColumnParent" style="border: 0px none transparent; border-radius: 0px; border-collapse: separate;">
                                    <table name="bmeMainColumn" class="bmeHolder bmeMainColumn" style="max-width: 600px; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;" cellspacing="0" cellpadding="0" border="0" align="center">
                                        <tbody>
                                            <tr>
                                                <td width="100%" class="blk_container bmeHolder" name="bmePreHeader" valign="top" align="center" style="color: rgb(102, 102, 102); border: 0px none transparent; background-color: rgb(239, 25, 35);" bgcolor="#ef1923"></td>
                                            </tr>
                                            <tr>
                                                <td width="100%" class="bmeHolder" valign="top" align="center" name="bmeMainContentParent" style="border: 0px none rgb(102, 102, 102); border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;">
                                                    <table name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                                        <tbody>
                                                            <tr>
                                                                <td width="100%" class="blk_container bmeHolder" name="bmeHeader" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(239, 25, 35);" bgcolor="#ef1923">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 15px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
																														<div style="line-height: 150%; text-align: right;"><span style="font-size: 12px; font-family: 'Courier New', Courier; color: #ffffff; line-height: 150%;"><span style="text-decoration: underline; line-height: 150%;">
																															<a href="{{ url('/') }}"><p class="site"><font color="white">www.asonataxela.com</font></p></a></span></span>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 20px;"><a href="{{ url('/') }}"><img src="{{asset('fronttemplate/assets/images/logos/logo.jpg')}}" alt="Asonata Xela" height="100"></a></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            <span style="font-size: 16px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">
                                                                                                                                <strong>
                                                                                                                                    Se te ha creado una nueva inscripción en <a href="{{ url('/') }}">www.asonataxela.com</a>
                                                                                                                                </strong>
                                                                                                                            </span>
                                                                                                                            <ul>
                                                                                                                                @php
                                                                                                                                ...
                                                                                                                                @endphp
                                                                                                                                <li><b>Atleta:</b> {{ $atleta->name }}</li>
                                                                                                                                <li><b>Clase:</b> {{ $category->name }} ({{ $cycle->name }})</li>
                                                                                                                                <li><b>Fecha Inscripcion:</b> {{ date("d-m-Y", strtotime($inscription->created_at)) }}</li>
                                                                                                                                <li><b>Numero Inscripción:</b> {{ $inscription->inscription_number }}</li>
                                                                                                                                <li>
                                                                                                                                    <b>Estado Inscripción:</b>
                                                                                                                                    <font color="{{
                                                                                                                                        $inscription->inscription_status == '0' ? 'orange'
                                                                                                                                        : ($inscription->inscription_status == '1' ? 'limegreen'
                                                                                                                                        : ($inscription->inscription_status == '2' ? 'red'
                                                                                                                                        : ($inscription->inscription_status == '3' ? 'black'
                                                                                                                                        : ($inscription->inscription_status == '4' ? 'gray'
                                                                                                                                        : ($inscription->inscription_status == '5' ? 'blue' : ""
                                                                                                                                        ))))) }}">
                                                                                                                                ...
                                                                                                                                <li>
                                                                                                                                    ...
                                                                                                                                    <font color="{{
                                                                                                                                        $inscription->inscription_payment == '0' ? 'orange'
                                                                                                                                        : ($inscription->inscription_payment == '1' ? 'limegreen' : ""
                                                                                                                                        ) }}">
                                                                                                                                        {{ $inscription->inscription_status == '0' ? __('Pending')
                                                                                                                                        : ($inscription->inscription_status == '1' ? __('Paid'): ""
                                                                                                                                        ) }}
                                                                                                                                    </font>
                                                                                                                                </li>
                                                                                                                                <li>
                                                                                                                                    <b>Pago Gafete:</b>
                                                                                                                                    <font color="{{
                                                                                                                                        $inscription->badge_payment == '0' ? 'orange'
                                                                                                                                        : ($inscription->badge_payment == '1' ? 'limegreen' : ""
                                                                                                                                        ) }}">
                                                                                                                                        {{ $inscription->badge_payment == '0' ? __('Pending')
                                                                                                                                        : ($inscription->badge_payment == '1' ? __('Paid'): ""
                                                                                                                                        ) }}
                                                                                                                                    </font>
                                                                                                                                </li>
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">Podrás ver el estado de la misma presionando en el siguiente botón:</span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" style="border-collapse: separate;">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td style="border-radius: 0px; border: 3px solid rgb(239, 25, 35); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;" class="bmeButtonText"><span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(66, 66, 66);"><a href="{{ url('/query-inscription?inscription_number='.$inscription->inscription_number) }}" style="color: rgb(66, 66, 66); text-decoration: none;" target="_blank">Ver Inscripción</a></span></td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td valign="top" name="bmeSocialTD" class="bmeSocialTD">
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="padding-right:20px;height:20px;">
                                                                                                                                        <a href="https://www.facebook.com/HighlandNaturalPark/" target=_blank style="display: inline-block;background-color: rgb(239, 25, 35);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="{{asset('hltemplate/images/redes/Fb.png')}}" alt="Facebook" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
                                                                                                                        ...
                                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeFollowItem" type="Instagram" style="float: left; display: block;" align="left">
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="padding-right:20px;height:20px;">
                                                                                                                                        <a href="https://www.instagram.com/naturalhiglandpark/" target=_blank style="display: inline-block;background-color: rgb(239, 25, 35);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="{{asset('hltemplate/images/redes/Insta.png')}}" alt="Instagram" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
                                                                                                                        <!--[if gte mso 6]></td><td align="left" valign="top"><![endif]-->
                                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeFollowItem" type="Youtube" style="float: left; display: block;" align="left">
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="height:20px;">
                                                                                                                                        <a href="" target=_blank style="display: inline-block;background-color: rgb(239, 25, 35);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="{{asset('hltemplate/images/redes/Insta.png')}}" alt="Youtube" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
