...
class CreateTerapiaSesionIzquierdasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('terapia_sesion_izquierdas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('terapia_sesion_izquierdas');
    }
}
